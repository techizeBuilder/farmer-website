  ...
  const sendPasswordChangeOtp = useMutation({
    mutationFn: async (data: PasswordChangeFormData) => {
      const response = await fetch('/api/auth/send-otp', {
        ...
        body: JSON.stringify({ mobile: (user as any)?.mobile, purpose: 'password_reset' })
      });
                        ...
                        <Form {...passwordForm}>
                          <form onSubmit={passwordForm.handleSubmit(onPasswordChangeSubmit)} className="space-y-4">
                            ...
                            <div className="flex items-center gap-4">
                              ...
                              >
                                {sendPasswordChangeOtp.isPending ? 'Sending OTP...' : 'Send OTP'}
                              </Button>
                              <Button 
                                variant="outline" 
                                type="button" 
                        ...
                        <div className="space-y-6">
                          ...
                          <div className="space-y-3">
                            <Button 
                              ...
                              className="w-full" 
                              disabled={changePassword.isPending || otp.length !== 6}
                            >
                              {changePassword.isPending ? 'Changing Password...' : 'Verify & Change Password'}
                            </Button>
                            ...
                            <div className="flex items-center gap-4">
                              <Button
                                ...
                                className="text-sm"
                              >
                                {sendPasswordChangeOtp.isPending ? 'Resending...' : 'Resend OTP'}
                              </Button>
